...
{
    public partial class BUSCAR_PERSONAL2 : Form
    {
        public BUSCAR_PERSONAL2()
        {
            InitializeComponent();
        }
        ...
        private void BUSCAR_PERSONAL2_Load(object sender, EventArgs e)
        {
            this.leer_datos("select * from recursosHumanos", ref resultados, "recursosHumanos");
            this.mifiltro = ((DataTable)resultados.Tables["recursosHumanos"]).DefaultView;
        ...
        private void txtBuscar_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            foreach (string palabra in palabras_busqueda)
            {
                if (salida_datos.Length == 0)
                {
                    ...
                    salida_datos = "(Nombres LIKE '%" + palabra + "%')";
                }
                else
                {
