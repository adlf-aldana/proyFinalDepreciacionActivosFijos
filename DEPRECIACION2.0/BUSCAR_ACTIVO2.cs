...
{
    public partial class BUSCAR_ACTIVO2 : Form
    {
        public BUSCAR_ACTIVO2()
        {
            InitializeComponent();
        }
        ...
        private void BUSCAR_ACTIVO2_Load(object sender, EventArgs e)
        {
            this.leer_datos("select * from activoFijo", ref resultados, "activoFijo");
            this.mifiltro = ((DataTable)resultados.Tables["activoFijo"]).DefaultView;
